...
export const InitDB = () => {
  try {
    ...
    console.log("DbConfig@InitDB", err);
...
export const TB_WATCHER_BLOCKS = process.env.TB_WATCHER_BLOCKS
  ? process.env.TB_WATCHER_BLOCKS
  : "blockchain_watcher_blocks_dev";
export const TB_WATCHER = process.env.TB_WATCHER
  ? process.env.TB_WATCHER
  : "blockchain_watcher_dev";
